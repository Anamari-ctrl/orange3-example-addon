...
from AnyQt.QtWidgets import QLabel, QVBoxLayout, QWidget, QSizePolicy, QApplication
...
class ImageWidget(QWidget):
    ...
    def display_image(self, array):
        image = ImageWidget.numpy_array_to_qimage(array)
...
class BlendImages(OWWidget):
    ...
    def __init__(self):
        ...
        image1 = "/home/anamari/orange3-example-addon/orangecontrib/example/widgets/images/StarryNight_VanGogh.jpg"
        image2 = "/home/anamari/orange3-example-addon/orangecontrib/example/widgets/images/TheKiss_Klimt.jpg"

        image1_array = np.array(Image.open(image1))
        image2_array = np.array(Image.open(image2))

        
        self.image1_slider = ImageWidget.numpy_array_to_qimage(image1_array)
        self.image2_slider = ImageWidget.numpy_array_to_qimage(image2_array)
        ...
        slider_box.layout().addWidget(self.image1_slider)
        slider_box.layout().addWidget(self.slider)
        slider_box.layout().addWidget(self.image2_slider)

        self.slider.callback = self._slider_changed
...
if __name__ == "__main__":
    ...
    main_window.set_image1(image1_array)
    main_window.set_image2(image2_array)
